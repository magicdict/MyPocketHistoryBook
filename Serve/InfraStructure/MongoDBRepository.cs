...
namespace InfraStructure.DataBase
{
    ...
    public static class MongoDbRepository
    {
        ...
        ///     插入记录
        /// </summary>
        /// <typeparam name="T">继承于EntityBase的类</typeparam>
        /// <param name="obj"></param>
        /// <param name="createUser"></param>
        public static string InsertRec<T>(T obj, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
        ...
        /// <returns></returns>
        public static string InsertRec<T>(T obj, int Sn, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(obj.GetCollectionName());
            FillBaseInfo(obj, createUser);
            lock (objLock)
            {
                obj.Sn = obj.GetPrefix() + Sn.ToString(EntityBase.SnFormat);
                targetCollection.Insert(obj);
            }
            return obj.Sn;
        }
        ...
        /// <param name="SNFormat">SN格式化方法</param>
        /// <param name="createUser"></param>
        /// <returns></returns>
        public static string InsertRec<T>(T obj, Func<long, string> SNFormat, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(obj.GetCollectionName());
            FillBaseInfo(obj, createUser);
            lock (objLock)
            {
                obj.Sn = obj.GetPrefix() + SNFormat(targetCollection.Count() + 1);
                targetCollection.Insert(obj);
            }
            return obj.Sn;
        }
        ...
        /// <param name="createUser"></param>
        /// <returns></returns>
        public static List<string> InsertRecList<T>(List<T> obj, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
        ...
        /// <param name="createUser"></param>
        public static string InsertRecByDatabase<T>(T obj, string databaseType, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
        ...
        /// <param name="collectionName"></param>
        /// <param name="createUser"></param>
        public static string InsertRec<T>(T obj, string collectionName, string createUser = UserSystem) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(collectionName);
            FillBaseInfo(obj, createUser);
        ...
        public static void UpdateRec<T>(T obj, string updateUser = UserSystem) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(obj.GetCollectionName());
            obj.UpdateDateTime = DateTime.Now;
        ...
        /// <param name="collectionName"></param>
        /// <param name="updateUser"></param>
        public static void UpdateRec<T>(T obj, string collectionName, string updateUser = UserSystem) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(collectionName);
            obj.UpdateDateTime = DateTime.Now;
            obj.UpdateUser = updateUser;
        ...
        public static void UpdateRec<T>(T obj, string Field, BsonValue value) where T : EntityBase, IEntityBase, new()
        {
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        public static void DeleteRec<T>(T obj, string deleteUser = UserSystem) where T : EntityBase, IEntityBase
        {
        ...
        public static void DeleteRec<T>(T obj, string collectionName, string deleteUser = UserSystem) where T : EntityBase, IEntityBase
        {
            var query = Query.EQ(MongoKeyField, obj.Sn);
        ...
        public static void DeleteRec<T>(string sn, string collectionName, string deleteUser = UserSystem)
            where T : EntityBase, IEntityBase
        {
        ...
        /// <param name="CollectionName"></param>
        /// <param name="deleteUser"></param>
        public static void DeleteRec<T>(string sn, string deleteUser = UserSystem) where T : EntityBase, IEntityBase, new()
        {
            var query = Query.EQ(MongoKeyField, sn);
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="query"></param>
        public static void RecoverRec<T>(IMongoQuery query) where T : EntityBase, IEntityBase, new()
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(new T().GetCollectionName());
            var update = new UpdateBuilder();
            update.Set(nameof(EntityBase.IsDel), false);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static List<T> GetDeleteRecList<T>(IMongoQuery query) where T : EntityBase, IEntityBase, new()
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(new T().GetCollectionName());
        ...
        /// <returns></returns>
        [Obsolete]
        public static T GetRecBySN<T>(string collectionName, string sn) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(collectionName);
            var query = Query.EQ(MongoKeyField, sn);
        ...
        /// <param name="sn"></param>
        /// <returns></returns>
        public static T GetRecBySN<T>(string sn) where T : EntityBase, IEntityBase, new()
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(new T().GetCollectionName());
            var query = Query.EQ(MongoKeyField, sn);
            query = Query.And(query, NotDeletequery);
        ...
        /// <returns></returns>
        [Obsolete]
        public static T GetFirstRec<T>(string collectionName, IMongoQuery query) where T : EntityBase, IEntityBase
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(collectionName);
            query = Query.And(query, NotDeletequery);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static T GetFirstRec<T>(IMongoQuery query) where T : EntityBase, IEntityBase, new()
        {
            MongoCollection targetCollection = InnerDefaultDatabase.GetCollection(new T().GetCollectionName());
            query = Query.And(query, NotDeletequery);
            return (T)targetCollection.FindOneAs(typeof(T), query);
        ...
        public static List<T> GetRecList<T>(IMongoQuery query = null, Action<MongoCursor> setCursor = null,
                                            string databaseType = "") where T : EntityBase, IEntityBase, new()
        {
            if (string.IsNullOrEmpty(databaseType)) databaseType = _defaultDatabaseName;
            var innerDb = GetDatabaseByType(databaseType);
        ...
        ///     获得件数
        /// </summary>
        public static int GetRecordCount<T>() where T : EntityBase, IEntityBase, new() { return GetRecordCount<T>(null); }
        ...
        /// <param name="collectionName"></param>
        /// <returns></returns>
        public static int GetRecordCount<T>(IMongoQuery query, bool includeDeleted = false) where T : EntityBase, IEntityBase, new()
        {
